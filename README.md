...
> [!NOTE]
> 您的「長期記憶」、「已學會技能」與「Discord Token」都儲存在 `Shared_Vault` 與 `.env` 中，會隨著資料夾直接遷移。
...
> ArielOS v4.2 | 2026-02-23 | **Hybrid AI Search** · CPU Spinal Chord Reflexes · Stealth Playwright Probes · Programmatic Core · Disaster Recovery
